...
public class HighLightTable {
  ...
  public static String[] ALL_COLUMNS = new String[]{ID, COL_BOOK_ID, COL_CONTENT, COL_CONTENT_POST,
      COL_CONTENT_PRE, COL_DATE, COL_HIGHLIGHT_ID, COL_PAGE, COL_TYPE, COL_PAGER_POSITION,
      COL_CURRENT_WEBVIEWSCROLL, COL_NOTE};
  ...
  public static ArrayList<Highlight> getAllHighlights(String bookId) {
    ...
    Cursor highlightCursor = DbAdapter
        .getAllByKey(HighLightTable.TABLE_NAME, HighLightTable.ALL_COLUMNS,
            HighLightTable.COL_BOOK_ID, bookId);
  ...
  public static void deleteHighlight(String highlightId) {
    if (DbAdapter
        .deleteById(HighLightTable.TABLE_NAME, HighLightTable.COL_HIGHLIGHT_ID, highlightId)) {
  ...
  public static void updateHighlight(Highlight highlight) {
    if (DbAdapter.update(HighLightTable.TABLE_NAME, COL_HIGHLIGHT_ID, highlight.getHighlightId(),
        getHighlightContentValues(highlight))) {
