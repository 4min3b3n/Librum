...
public class Highlight implements Parcelable {
  ...
  public Highlight(String bookId, String content, String contentPost, String contentPre, Date date,
      String highlightId, int page, String type, int currentPagerPostion,
      int currentWebviewScrollPos, String note) {
    this.bookId = bookId;
    this.content = content;
    this.contentPost = contentPost;
    this.contentPre = contentPre;
  ...
  public boolean equals(Object o) {
    ...
    if (date != null ? !date.equals(highlight.date) : highlight.date != null) {
      return false;
    }
    if (highlightId != null ? !
