...
public class FolioPageFragment extends Fragment implements HtmlTaskCallback,
   ...
   *
   * @param event of type {@link MediaOverlaySpeedEvent} contains selected speed type
   * HALF,ONE,ONE_HALF and TWO.
   */
  @SuppressWarnings("unused")
  @Subscribe
   ...
   *
   * @param event of type {@link MediaOverlaySpeedEvent} contains selected style of type
   * DEFAULT,UNDERLINE and BACKGROUND.
   */
  @SuppressWarnings("unused")
  @Subscribe
  ...
  /**
   * [EVENT BUS FUNCTION] Function triggered from {@link FolioActivity#onActivityResult(int, int,
   * Intent)} when any item in toc clicked.
   *
      ...
      public void onPageFinished(WebView view, String url) {
        if (isAdded()) {
          ...
          if (mWebviewposition != null) {
            ...
            setWebViewPosition(
                AppUtil.getPreviousBookStateWebViewPosition(getActivity(), mBookTitle));
