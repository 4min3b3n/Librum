...
public class FolioActivity
    ...
    findViewById(R.id.btn_drawer).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(FolioActivity.this, ContentHighlightActivity.class)
            .putExtra(CHAPTER_SELECTED, mSpineReferenceList.get(mChapterPosition).href);
  ...
  private void initBook(String mEpubFileName, int mEpubRawId, String mEpubFilePath,
      EpubSourceType mEpubSourceType) {
    try {
      mEpubServer = EpubServerSingleton.getEpubServerInstance(Constants.PORT_NUMBER);
      mEpubServer.start();
      String path = FileUtil
          .saveEpubFileAndLoadLazyBook(FolioActivity.this, mEpubSourceType, mEpubFilePath,
  ...
  private void configFolio() {
    ...
    mFolioPageViewPager.setOnPageChangeListener(new DirectionalViewpager.OnPageChangeListener() {
      ...
      public void onPageSelected(int position) {
        FolioActivity.BUS.post(
            new MediaOverlayPlayPauseEvent(mSpineReferenceList.get(mChapterPosition).href, false,
                true));
        mPlayPauseBtn
            .setImageDrawable(ContextCompat.getDrawable(FolioActivity.this, R.drawable.play_icon));
    ...
    if (AppUtil.checkPreviousBookStateExist(FolioActivity.this, EPUB_TITLE)) {
      mFolioPageViewPager
          .setCurrentItem(AppUtil.getPreviousBookStatePosition(FolioActivity.this, EPUB_TITLE));
    }
  }
  ...
  private void configDrawerLayoutButtons() {
    ...
    findViewById(R.id.btn_config).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        mConfigBottomSheetDialogFragment
            .show(getSupportFragmentManager(), mConfigBottomSheetDialogFragment.getTag());
      }
    });
  }
  ...
  private void saveBookState() {
    if (mSpineReferenceList.size() > 0) {
      AppUtil.saveBookState(FolioActivity.this, EPUB_TITLE, mFolioPageViewPager.getCurrentItem(),
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    if (requestCode == ACTION_CONTENT_HIGHLIGHT && resultCode == RESULT_OK && data.hasExtra(TYPE)) {
      ...
      if (type.equals(CHAPTER_SELECTED)) {
        ...
        BUS.post(new WebViewPosition(mWebViewScrollPosition,
            mSpineReferenceList.get(mChapterPosition).href));
      }
    }
  }
  ...
  private void initAudioView() {
      ...
      public void onClick(View v) {
        if (mIsSpeaking) {
          ...
          mPlayPauseBtn.setImageDrawable(
              ContextCompat.getDrawable(FolioActivity.this, R.drawable.play_icon));
        } else {
          FolioActivity.BUS.post(
              new MediaOverlayPlayPauseEvent(mSpineReferenceList.get(mChapterPosition).href, true,
                  false));
          mPlayPauseBtn.setImageDrawable(
              ContextCompat.getDrawable(FolioActivity.this, R.drawable.pause_btn));
        }
    ...
    mBackgroundColorStyle.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        FolioActivity.BUS.post(
            new MediaOverlayHighlightStyleEvent(MediaOverlayHighlightStyleEvent.Style.DEFAULT));
      }
    });
    ...
    mUnderlineStyle.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        mTextColorStyle.setSelected(false);
        FolioActivity.BUS.post(
            new MediaOverlayHighlightStyleEvent(MediaOverlayHighlightStyleEvent.Style.UNDERLINE));
    ...
    mTextColorStyle.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        FolioActivity.BUS.post(
            new MediaOverlayHighlightStyleEvent(MediaOverlayHighlightStyleEvent.Style.BACKGROUND));
      }
    });
  }
